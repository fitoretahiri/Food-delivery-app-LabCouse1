...
namespace Food_delivery_app_LabCouse1.Migrations
{
    ...
    [Migration("20220710175533_dbTablesAdded")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CartItemMenu", b =>
                {
                    ...
                    b.HasKey("CartID", "MenuID");

                    b.HasIndex("MenuID");

                    b.ToTable("CartItemMenu");
                });

            modelBuilder.Entity("Food_delivery_app_LabCouse1.Models.CartItem", b =>
                {
                    b.Property<int>("CartID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Food_delivery_app_LabCouse1.Models.CartMenu", b =>
                {
                    b.Property<int>("MenuID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Food_delivery_app_LabCouse1.Models.Lagje", b =>
                {
                    b.Property<int>("LagjeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .UseIdentityColumn();
            ...
            modelBuilder.Entity("CartItemMenu", b =>
                {
                    b.HasOne("Food_delivery_app_LabCouse1.Models.CartItem", null)
                        .WithMany()
                        .HasForeignKey("CartID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Food_delivery_app_LabCouse1.Models.Menu", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Food_delivery_app_LabCouse1.Models.CartMenu", b =>
                {
                    b.HasOne("Food_delivery_app_LabCouse1.Models.CartItem", "Cart")
                        .WithMany("CartMenus")
                        .HasForeignKey("CartID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Food_delivery_app_LabCouse1.Models.Qyteti", b =>
                {
                    b.HasOne("Food_delivery_app_LabCouse1.Models.Lagje", "Lagje")
                        .WithMany()
                        .HasForeignKey("LagjeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
